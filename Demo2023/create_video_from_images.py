...
#videoWriter = cv2.VideoWriter('videos/'+ filename + '_DJI_0014_resized_fps30.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, (width,height))
videoWriter = cv2.VideoWriter('videos/'+ filename + '_DJI_0014_DCE++_enhanced_fps30.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, (width,height))
